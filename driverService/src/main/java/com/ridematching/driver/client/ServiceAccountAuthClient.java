...
import com.ridematching.driver.dto.LoginRequest;
import com.ridematching.driver.dto.LoginResponse;
import com.ridematching.driver.dto.RegisterRequest;
...
public class ServiceAccountAuthClient {
    ...
    public synchronized void refreshToken() {
        ...
        log.info("driverService authenticated as {}", email);
    }
    ...
    private void register() {
        ...
        try {
            ...
            log.info("Registered driverService service account {}", email);
